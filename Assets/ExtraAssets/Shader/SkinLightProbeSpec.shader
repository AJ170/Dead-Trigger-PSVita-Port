Shader "Vita/Character/SkinLightProbeSpec" {
    Properties{
        ...
        SubShader{
            ...
            Pass {
                ...
                v2f vert(appdata v) {
                    ...
                    half3 sh = ShadeSH9(half4(worldNormal, 1.0));
                ...
                half4 frag(v2f i) : SV_Target {
                    ...
                    half3 specular = cubeReflection.rgb * _SpecColor.rgb * specularStrength * fresnel;
