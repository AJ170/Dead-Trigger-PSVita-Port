...
public class FasterMobileBloomWithDirt : MonoBehaviour
{
	...
	[Range(0.0f, 1.0f)] public float dirtIntensity = 0.5f;
	...
	private static int _DirtTexID = -1;
	private static int _DirtIntensityID = -1;
	...
	void InitializeShaderProperties()
	{
		if (_SpreadID == -1)
		{
			...
			_DirtTexID = Shader.PropertyToID("_DirtTex");
			_DirtIntensityID = Shader.PropertyToID("_DirtIntensity");
		}
	}
	...
	void OnRenderImage(RenderTexture source, RenderTexture destination)
	{
		...
		if (dirtTexture != null)
		{
			fastBloomMaterial.SetTexture(_DirtTexID, dirtTexture);
			fastBloomMaterial.SetFloat(_DirtIntensityID, dirtIntensity);
		}
